...
public class Board {
	...
	public Board(int linhas, int colunas) {
		...
		if(linhas < 1 || colunas < 1) {
			throw new BoardException("Erro ao criar tabuleiro: é necessário que haja pelo "
	...
	public boolean posicaoTemPeca(Position posicao) {
		...
		//O método peca() está declarado acima e retorna a posição quando há alguma peça, portanto, 
		//para testarmos se está ocupada basta receber o retorno, se for diferente de null tem peça na posição.
