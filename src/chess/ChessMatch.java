...
public class ChessMatch {
	...
	private void proximoTurno() {
		turno++;
		// Se o jogador atual é == Color.WHITE então agora vai ser Color.BLACK. Caso
		// contrário ":" Color.WHITE.
	...
	private ChessPiece king(Color cor) {
		...
		// Se ocorrer esta exceção há um problema no jogo como um todo pois sempre
		// haverá um rei antes do fim do jogo.
